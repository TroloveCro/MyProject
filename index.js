...
mp.events.add("render", () => {
    if (streetName && zoneName) {
        ...
        drawText(zoneName, [minimap.rightX + 0.01, minimap.bottomY - 0.035], 4, [0, 191, 255, 255], 0.5);

        let vehicle = mp.players.local.vehicle;
        if (useSpeedo && vehicle) drawText(`${(vehicle.getSpeed() * 3.6).toFixed(0)} ${"KM/H"}`, [minimap.rightX - 0.003, minimap.bottomY - 0.0485], 4, [255, 255, 255, 255], 0.45, true);
    }
});